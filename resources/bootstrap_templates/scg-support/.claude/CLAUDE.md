...
`scg-support` contains shared support utilities used by services.

## Hard Boundaries

- Utility dumping ground is forbidden. Every package must have a clear purpose.
- No cyclic deps. Keep layering clean.
