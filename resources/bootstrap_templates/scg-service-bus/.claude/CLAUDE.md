...
`scg-service-bus` provides messaging/event bus abstractions and/or implementations.

## Hard Boundaries

- Keep interfaces minimal and explicit.
- Avoid leaky abstractions; if you can't hide the transport, don't pretend.
