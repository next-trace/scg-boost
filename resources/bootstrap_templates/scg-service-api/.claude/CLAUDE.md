...
Shared API contracts/DTOs between services (OpenAPI/Connect types, request/response structs).
...
`scg-service-api` contains shared API contracts:
- Request/response structs
- Error envelope conventions
- Shared pagination/filter primitives
- (If used) Connect/gRPC/OpenAPI generated types

## Hard Boundaries

- Backward compatibility is king.
- No service-specific domain logic here.
- Any breaking change requires explicit versioning.
