# CLAUDE.md — scg-notification-contracts
...
`scg-notification-contracts` contains notification templates/schemas/contracts used across services.

## Hard Boundaries

- Treat notification payload shapes as contracts.
- No service-specific ad-hoc fields without versioning.
- Keep templates deterministic and testable.
